...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <title>Cours PHP - Les importations en PHP</title>
...
<body>
    ...
    <header class="p-5 m-4 bg-light rounded-3 border ">
            <section class="container py-5">
                <h1>Les importations des fichiers avec require() et include()</h1>
        ...
        <main class="container-fluid px-5">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 mt-5">
                    <h2 class="text-center border-top pt-5 my-5">
                        La fonction include
                    </h2>
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <?php
                                /*
                                    On va créer un dossier inc à la racine de notre dossier php. Dans ce dossier inc on va créer un fichier test1.inc.php . On crée une balise p avec une phrase : Ceci est le premier fichier d'inclusion.

                                */
                                include("inc/test1.inc.php");
                                // deuxième façon d'écrire sans les parenthèses : 
                                include "inc/test1.inc.php";
                            ?>
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <?php
                                /*
                                    Dans ce dossier inc, on va créer un fichier test2.inc.php. 
                ...
                <div class="col-sm-12 mt-5">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <?php
                            /**
                             * On vas créer un fichier test3.inc.php dans le dossier inc
                             * On crée une balise p avec la phrase : Ceci est le premier fichier d'inclusion avec require
                             */
                        ...
                        <div class="col-sm-12 col-md-6">
                             ...
                             * On crée une balise p avec une phrase : Ceci est le deuxième fichier d'inclusion avec require_once
                             */
